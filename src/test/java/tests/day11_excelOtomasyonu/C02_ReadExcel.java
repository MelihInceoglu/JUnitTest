...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        String IstnenHucre=sayfa1.getRow(0).getCell(1).toString();

        System.out.println(IstnenHucre);
        ...
        System.out.println(sayfa1.getLastRowNum()); //indexe bakıyor 190
        ...
        //sayfa2 için son satır numaarsı ve fziki olarak kullanılan satır sayısıı yazdırın

        Sheet sayfa2= workbook.getSheet("Sayfa2");

        System.out.println("son satır indexi " +sayfa2.getLastRowNum());
        System.out.println("Fiziki olarak kullanılan satır sayisi "+ sayfa2.getPhysicalNumberOfRows());


        //Listede Togo isminde bir ülke oldugunu test edin
        ...
        //Listede Benin isminde bir ülke oldugunu test edin

        Assert.assertTrue(ulkelerMap.containsKey("Benin"));


        //Listede Ankara isminde bir başkent oldugunu test edin
